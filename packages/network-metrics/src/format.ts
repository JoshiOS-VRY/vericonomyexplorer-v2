 ...
 */
export function formatNetworkHashrateKhPerMin(
  khPerMin: number | null | undefined,
): string {
...
export function formatNetworkHashrateFromHps(
  hashPerSec: number | null | undefined,
): string {
