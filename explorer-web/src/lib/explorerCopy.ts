...
const USER_MESSAGE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/No blocks have been indexed for this chain\./gi, 'No blocks are available for this chain yet.'],
  ...
  [/(\d[\d,]*) block(s?) behind chain tip\./gi, '$1 block$2 behind the latest block.'],
