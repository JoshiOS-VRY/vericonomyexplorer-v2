...
export function BlockMiningCard({ result }: { result: BlockResult }) {
  ...
  return (
    <section className="rounded-xl border border-accent/20 bg-accent/5 shadow-sm">
      ...
      <div className="grid gap-4 p-5 sm:grid-cols-3">
        {coinbase ? (
          <div>
            <div className="text-[10px] font-medium uppercase tracking-wide text-fg-subtle">Coinbase tx</div>
            <Link href={`/vrm/tx/${coinbase.txid}`} className="mt-1 block font-mono text-xs text-accent hover:underline">
        ...
        {coinbase ? (
          <div>
            <div className="text-[10px] font-medium uppercase tracking-wide text-fg-subtle">Block reward</div>
        ...
        <div>
          <div className="text-[10px] font-medium uppercase tracking-wide text-fg-subtle">Extracted by</div>
          <div className="mt-1">
