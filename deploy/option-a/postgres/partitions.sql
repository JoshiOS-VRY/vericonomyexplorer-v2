...
CREATE TABLE IF NOT EXISTS block_mint_vrm PARTITION OF block_mint FOR VALUES IN ('vrm');
CREATE TABLE IF NOT EXISTS block_mint_vrc PARTITION OF block_mint FOR VALUES IN ('vrc');
