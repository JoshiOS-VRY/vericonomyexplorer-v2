...
!(function (e, t) {
  ...
  function q(e, t, n) {
    e.isValid() &&
      ...
      ('FullYear' === t && j(e.year()) && 1 === e.month() && 29 === e.date()
        ? ((n = Z(n)), e._d['set' + (e._isUTC ? 'UTC' : '') + t](n, e.month(), Te(n, e.month())))
  ...
  function lt(e) {
    var t = null;
    if (void 0 === rt[e] && 'undefined' != typeof module && module && module.exports)
      try {
  ...
  function ct(e) {
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          t = (i = ut(e[r]).split('-')).length, n = (n = ut(e[r + 1])) ? n.split('-') : null;
          t > 0;
  ...
  function St(e) {
    ...
    if (l) {
      if (
        ...
        (a = l[6]),
        (o = l[7]),
        (u = [Dt(n), Pe.indexOf(s), parseInt(i, 10), parseInt(r, 10), parseInt(a, 10)]),
            ...
            (function (e) {
              ...
              s < 1 || s > Ie(n, r, a)
                ...
                : null != u
                  ...
                  : ((o = Ae(n, s, i, r, a)), (e._a[ve] = o.year), (e._dayOfYear = o.dayOfYear));
            })(e),
          null != e._dayOfYear &&
            ((a = Yt(e._a[ve], i[ve])),
            (e._dayOfYear > Le(a) || 0 === e._dayOfYear) && (f(e)._overflowDayOfYear = !0),
    ...
    if (e._f !== n.ISO_8601)
      if (e._f !== n.RFC_2822) {
        ...
        for (i = H(e._f, e._locale).match(N) || [], t = 0; t < i.length; t++)
          ((r = i[t]),
            (s = (u.match(fe(r, e)) || [])[0]) &&
              ((a = u.substr(0, u.indexOf(s))).length > 0 && f(e).unusedInput.push(a),
  ...
  function Gt(e, t) {
    ...
    return null === i
      ? null
      : 0 === (s = 60 * (n = ((i[i.length - 1] || []) + '').match(Vt) || ['-', 0, 0])[1] + Z(n[2]))
        ? 0
        : '+' === n[0]
          ? s
          : -s;
  ...
  ((Dn.add = Qt),
    ...
    (Dn.endOf = function (e) {
      ...
      switch (((s = this._isUTC ? cn : dn), e)) {
        ...
        case 'hour':
          ((t = this._d.valueOf()),
            (t += un - hn(t + (this._isUTC ? 0 : this.utcOffset() * on), un) - 1));
          break;
        case 'minute':
    ...
    (Dn.eraName = function () {
      ...
      for (e = 0, t = s.length; e < t; ++e) {
        if (((n = this.startOf('day').valueOf()), s[e].since <= n && n <= s[e].until))
          return s[e].name;
    ...
    (Dn.local = function (e) {
      return (
        this._isUTC &&
          (this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(At(this), 'm')),
        this
      );
    }),
    ...
    (Dn.hasAlignedHourOffset = function (e) {
      return (
        !!this.isValid() && ((e = e ? Nt(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
      );
    }),
    (Dn.isDST = function () {
      return (
  ...
  ((Yn.calendar = function (e, t, n) {
    ...
    (Yn.months = function (e, t) {
      return e
        ? s(this._months)
          ...
          : this._months[(this._months.isFormat || Re).test(t) ? 'format' : 'standalone'][e.month()]
        : s(this._months)
          ? this._months
    ...
    (n.langData = M('moment.langData is deprecated. Use moment.localeData instead.', ct)));
  var Tn = Math.abs;
  function Nn(e, t, n, s) {
    var i = zt(t, n);
    return (
  ...
  return (
    ...
    (ss.humanize = function (e, t) {
      ...
      return (
        ...
        'object' == typeof t &&
          ((r = Object.assign({}, Kn, t)), null != t.s && null == t.ss && (r.ss = t.s - 1)),
        (s = (function (e, t, n, s) {
          var i = zt(e).abs(),
            r = Xn(i.as('s')),
            a = Xn(i.as('m')),
    ...
    (n.relativeTimeThreshold = function (e, t) {
      return (
        void 0 !== Kn[e] && (void 0 === t ? Kn[e] : ((Kn[e] = t), 's' === e && (Kn.ss = t - 1), !0))
      );
    }),
