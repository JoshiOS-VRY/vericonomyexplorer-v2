...
if (
  after.balances.length !== 1 ||
  after.balances[0].address !== 'VAddressReceive111111111111111111111'
) {
...
if (after.balances[0].balance_sats !== 5000000000n) {
  throw new Error(
    `Expected funding balance of 50 coins after rollback, found ${after.balances[0].balance_sats}`
  );
}
