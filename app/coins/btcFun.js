  ...
  items: [
    {
      ...
      alertBodyHtml:
        "This is the first block in the Bitcoin blockchain, known as the <b>Genesis Block</b>. This block was mined by Bitcoin's creator <b>Satoshi Nakamoto</b>.<br/>Read more here: <a href='https://en.bitcoin.it/wiki/Genesis_block'>bitcoin.it/wiki/Genesis_block</a>.",
    ...
    },
    {
      ...
      blockHeight: 71036,
      summary:
        'Early transaction with MANY (4,000+) OP_CHECKSIG commands, before this DoS vector was fixed',
      alertBodyHtml:
        'Multiple transactions in Block #71,036, including this one, included MANY OP_CHECKSIG commands, causing nodes to perform unnecessary work, and helped identify a possible denial-of-service (DoS) attack. A new version of Bitcoin was quickly released. The new version did not cause a fork on the main network, though it did cause one on the test network (where someone had played around with the attack more).',
    ...
    },
    {
      ...
      alertBodyHtml:
        "This address corresponds to a Bitcoin Script (<span class='font-data'>6e879169a87ca887</span>) that allows anyone who can demonstrate a SHA256 collision to spend from it. On September 13, 2013 this address was funded as a SHA256-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
      referenceUrl: 'https://bitcointalk.org/index.php?topic=293382.0',
    },
    {
      type: 'address',
    ...
    },
    {
      ...
      alertBodyHtml:
        "This address corresponds to a Bitcoin Script (<span class='font-data'>6e879169a97ca987</span>) that allows anyone who can demonstrate a RIPEMD160(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a RIPEMD160(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
      referenceUrl: 'https://bitcointalk.org/index.php?topic=293382.0',
    },
    {
      type: 'address',
      ...
      alertBodyHtml:
        "This address corresponds to a Bitcoin Script (<span class='font-data'>6e879169aa7caa87</span>) that allows anyone who can demonstrate a SHA256(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a SHA256(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
      referenceUrl: 'https://bitcointalk.org/index.php?topic=293382.0',
    },
    {
      type: 'blockheight',
    ...
    },
    {
      ...
      alertBodyHtml:
        'This transaction filled the entire 1MB block, mostly sweeping weak brainwallets. At the time, it needed 25 seconds to validate.',
    ...
    },
    {
      ...
      alertBodyHtml:
        "With the coinbase message 'Times 09/Apr/2020 With $2.3T Injection, Fed's Plan Far Exceeds 2008 Rescue', this final block of subsidy era #3 (12.5 BTC) echoes the spiritual call-to-action of <a href='./block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'>Satoshi's genesis block</a>.",
    },
    {
      type: 'tx',
      date: '2017-08-24',
    ...
    },
    {
      ...
      alertBodyHtml:
        'This is the famous "Bitcoin Pizza" transaction, one of the earliest real-world transactions, in which 10,000 BTC was paid for 2 large pizzas worth ~41 USD (at an effective exchange rate of ~$0.004/BTC).',
    ...
    },
    {
      ...
      alertBodyHtml:
        "The miner of block <a href='./block-height/124724'>124,724</a> (<a href='https://bitcointalk.org/index.php?action=profile;u=2759'>midnightmagic on BitcoinTalk</a>) deliberately underpaid themselves 1 satoshi from the block subsidy (in addition to deliberately ignoring the fees for transactions included in that block). The 'missing satoshi' (to use midnight magic's words), was a tribute to Satoshi's disappearance.",
    ...
    },
    {
      ...
      alertBodyHtml:
        'This block comes 9 days after the genesis block and is the first to contain a transfer of bitcoin. Before this block all blocks contained only coinbase transactions, which mint new bitcoin.<br/>See transaction #1 (f4184fc…) below for more info.',
    ...
    },
    {
      ...
      alertBodyHtml:
        'This transaction represents the first ever transfer of bitcoin from one person to another. It also has the added distinction of being (one of?) the only known transfers of bitcoin from Satoshi Nakamoto, in this case sending bitcoin to Hal Finney as a test.',
    },
    {
      type: 'blockheight',
      date: '2017-08-25',
    ...
    },
    {
      ...
      alertBodyHtml:
        "On July 15, 2020 a hack involving many prominent Twitter accounts, including Elon Musk's, Bill Gates', and Cash App's, scammed many people to send BTC to this address.",
    ...
    },
    {
      ...
      alertBodyHtml:
        'This transaction from November 2011 spends 11 UTXOs worth 50,000 BTC to create a single 550,000 BTC UTXO. This is currently the largest output transaction.',
    ...
    },
    {
      ...
      alertBodyHtml:
        "This transaction encodes the Bitcoin whitepaper PDF in 945 of its 947 outputs. You can view the PDF, decoded from data served by your own node here: <a href='./bitcoin-whitepaper'>bitcoin whitepaper</a>. Or read more about the technical details - ",
      referenceUrl:
    ...
    },
    {
      ...
      alertBodyHtml:
        "Two of the transactions sent to this address encode the IP address of a botnet's command-and-control server. Using the censorship-resistant Bitcoin network to serve this data makes the botnet more resistant to takedown. The output value '6957' (in transaction <a href='./tx/35ef7fa5dd1e4d572279a74a83082bd3e77a0c3a468723b5def5d014ed634e84'>35ef7fa5dd…</a>) and the output value '36305' (in transaction <a href='./tx/3a1fcdea5495fb3a1aa410772860afd7841ba8830ffc0ab474d4d69458244e42'>3a1fcdea54…</a>) combine to encode the IPv4 address '209.141.45.27'.",
      referenceUrl:
    ...
    },
    {
      ...
      alertBodyHtml:
        "This block was the last 'Version 1' block to be mined. <a href='https://github.com/bitcoin/bips/blob/master/bip-0034.mediawiki'>BIP-34</a> defined 'Version 2' blocks and the 'bip34' soft fork was officially locked in 96 blocks after this one, in block #<a href='./block-height/227931'>227,931</a>.",
    ...
    },
    {
      ...
      alertBodyHtml:
        'This transaction includes a 983-byte OP_RETURN output. Although the default max size for OP_RETURN data is often quoted as 80 bytes, the 80-byte limit is a non-consensus rule that can vary from node to node (and is only enforced at mempool-acceptance time).',
    ...
    },
    {
      ...
      alertBodyHtml:
        "Shortly before a $1B+ USD Tesla treasury investment into Bitcoin was announced, Elon Musk updated his Twitter profile to just say '#Bitcoin' and cryptically tweeted 'It was inevitable'. Miner 'yhc5t3p' with F2Pool immortalized the tweet soon after.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "In celebration of their public listing and in homage to Satoshi's <a href='./block-height/0'>Genesis Block</a>, @Coinbase asked F2Pool to embed a message in the blockchain: 'NYTimes 10/Mar/2021 House Gives Final Approval to Biden's $1.9T Pandemic Relief'.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "Immortalizing the proposed legislation in El Salvador to classify bitcoin as legal tender in the country (a bill written in collaboration with <a href='https://Strike.me'>Strike.me</a>) Slush Pool embedded the headline: 'Diario El Salvador 6/Jun/2021 Bitcoin tendra validez legal'.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "As the last block of epoch #340, wherein over 90% of blocks were flagged by their miners to indicate Taproot acceptance/readiness, the mining of this block represents the lock-in of the Taproot soft fork on the network via the Speedy Trial activation mechanism. After lock-in, there was a delay period of 11 epochs before nodes began enforcing Taproot's rules in <a href='./block-height/709632'>Block #709,632</a>.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "Nearly 4 years after the Taproot upgrade was conceived, and after a contentious process of deciding how to safely upgrade the network, the Taproot soft fork locked in with the mining of <a href='./block-height/687455'>Block #687,455</a> and then finally began to be enforced by nodes in this block.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "Created by a modified version of <a href='https://twitter.com/bitcoindevkit'>@bitcoindevkit</a>, this Taproot script-spend with a 1-of-2 multisig is the first mainnet transaction to use OP_CHECKSIGADD.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "As a technical experiment and as a playful donation, User <a href='https://twitter.com/fiatjaf'>fiatjaf</a> intentionally created a situation where his lightning node would be penalized and forfeit funds to his channel counterparty. The second input to this transaction represents the penalty close, wherein all of the funds on fiatjaf's side of the channel were forfeited to his counterparty.",
    ...
    },
    {
      ...
      alertBodyHtml:
        "This transaction caused grief for multiple Bitcoin software projects (including this one...) It's a very large transaction that includes a huge number of empty input-script witness items. The underlying issue was inconsistency in handling of stack size relating to OP_SUCCESSx opcodes.",
    ...
    },
    {
      ...
      alertBodyHtml:
        'This transaction, which only needed $4.90 in fees to confirm, included a 998-of-999 tapscript multisig. It apparently broke LND (with the error "script witness item is larger than the max allowed size").',
    ...
    },
    {
      ...
      alertBodyHtml:
        'In order to address solvency concerns, early Bitcoin exchange Mt Gox performed a very large, public transaction from one of their addresses to another, thereby proving ownership of the large balance of coins (424,242.42424242 BTC).',
    ...
    },
    {
      ...
      alertBodyHtml:
        "A controversial 'digital artifact' project named Ordinals embeds content, named 'inscriptions', in the witness fields of transactions. This transaction includes the first such inscription, a PNG image, ever embedded in the mainnet BTC blockchain.",
      referenceUrl:
    ...
    },
    {
      ...
      alertBodyHtml:
        'This is the first send to a P2PKH Bitcoin address. Before this transaction, all outputs had been sent to P2PK outputs.',
    ...
    },
    {
      ...
      alertBodyHtml:
        'This is the first send to a P2MS output. This obscure and obsolete output type has hardly ever been used, but an example can be seen in output #0 of this transaction.',
      referenceUrl: 'https://unchained.com/blog/bitcoin-address-types-compared/',
    },
    {
      type: 'tx',
      ...
      alertBodyHtml:
        "This is the first send to a P2SH output, after the soft-fork enabling this output type was activated on April 1, 2012. For an example of a pre-soft-fork experiment with the output type, see <a href='./tx/9c08a4d78931342b37fd5f72900fb9983087e6f46c4a097d8a1f52c74e28eaf6'>transaction 9c08a4...</a>.",
      referenceUrl: 'https://unchained.com/blog/bitcoin-address-types-compared/',
    },
    {
      type: 'tx',
      ...
      blockHeight: 170052,
      summary:
        'First experimental (pre-activation) send to a Pay-to-Script Hash (P2SH) output, before the P2SH soft-fork activated',
      alertBodyHtml:
        "This is the actual first send to a P2SH output. It occurred nearly a month before the soft-fork enabling the feature (BIP 16) activated on April 1, 2012. For the first post-soft-fork send, see <a href='./tx/2597f4819e1902750b9e1fa1515df22bbf14f3a78a2b82aa7d62a8109d83289d'>transaction 2597f4...</a>.",
      referenceUrl: 'https://unchained.com/blog/bitcoin-address-types-compared/',
    },
    {
      type: 'tx',
      ...
      alertBodyHtml:
        "This is the first send to a P2WSH output and occurred in the <a href='./block-height/481824'>first SegWit-supporting block</a>.",
      referenceUrl: 'https://unchained.com/blog/bitcoin-address-types-compared/',
    },
    {
      type: 'tx',
      ...
      alertBodyHtml:
        "This is the first send to a P2WPKH output and occurred in the <a href='./block-height/481824'>first SegWit-supporting block</a>.",
      referenceUrl: 'https://unchained.com/blog/bitcoin-address-types-compared/',
    },
    {
      type: 'address',
      ...
      summary:
        'WikiLeaks began collecting public donations at this address on June 14, 2011. They collected over 4,000 BTC.',
    ...
    },
    {
      ...
      alertBodyHtml:
        'This transaction, sent from Satoshi Nakamoto to Mike Hearn is one of very few transactions originating from Satoshi. Jameson Lopp has also convincingly refuted that Hal Finney and Satoshi Nakamoto are the same person using blockchain and external evidence, including this particular transaction.',
    ...
    },
    {
      ...
      alertBodyHtml:
        "This user accidentally paid ~83 BTC ($3.1M at the time) for this transaction. This is one of the highest in Bitcoin's history.",
      referenceUrl:
    ...
    // testnet
    {
      ...
      alertBodyHtml:
        "This is the first block in the Bitcoin blockchain, known as the 'Genesis Block'. You can read more about <a href='https://en.bitcoin.it/wiki/Genesis_block'>the genesis block</a>.",
      referenceUrl: 'https://en.bitcoin.it/wiki/Genesis_block',
    },
    {
      type: 'tx',
