	...
	items: [
		{
			...
			alertBodyHtml: "This is the first block in the Verium blockchain, known as the <b>Genesis Block</b>. Verium is a Bitcoin fork designed for enhanced privacy and security with variable block times and unique reward mechanisms.<br/>Read more about Verium at: <a href='https://vericonomy.com/'>vericonomy.com</a>.",
		...
		},
		{
			...
			alertBodyHtml: "This is the first block mined after the Verium genesis block, marking the beginning of active mining on the Verium network.",
			referenceUrl: "https://vericonomy.com/"
		},
		{
			type: "blockheight",
			...
			alertBodyHtml: "This block represents an early milestone in the Verium network's development, showing the network's stability and growth.",
			referenceUrl: "https://vericonomy.com/"
		},
		{
			type: "blockheight",
			...
			alertBodyHtml: "Verium reached its 100,000th block, demonstrating the network's continued operation and growth since genesis.",
			referenceUrl: "https://vericonomy.com/"
		}
	]
};
