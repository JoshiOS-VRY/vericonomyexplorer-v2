...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
  return new Promise(function (resolve, reject) {
    ...
    if (config.addressApi == 'blockchain.com') {
      promises.push(
        blockchainAddressApi.getAddressDetails(address, scriptPubkey, sort, limit, offset)
      );
    } else if (config.addressApi == 'blockchair.com') {
      promises.push(
        blockchairAddressApi.getAddressDetails(address, scriptPubkey, sort, limit, offset)
      );
    } else if (config.addressApi == 'blockcypher.com') {
      promises.push(
        blockcypherAddressApi.getAddressDetails(address, scriptPubkey, sort, limit, offset)
      );
    } else if (config.addressApi == 'electrum' || config.addressApi == 'electrumx') {
      promises.push(
        electrumAddressApi.getAddressDetails(address, scriptPubkey, sort, limit, offset)
      );
