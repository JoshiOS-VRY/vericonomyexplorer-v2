module.exports = {
  ...
  routes: [
    ...
    // xyz-pubs
    {
      ...
      testUrl:
        '/util/xyzpub/xpub6EuV33a2DXxAhoJTRTnr8qnysu81AA4YHpLY6o8NiGkEJ8KADJ35T64eJsStWsmRf1xXkEANVjXFXnaUKbRtFwuSPCLfDdZwYNZToh4LBCd',
    },
    {
      category: 'xpubs',
      ...
      testUrl:
        '/xyzpub/addresses/xpub6EuV33a2DXxAhoJTRTnr8qnysu81AA4YHpLY6o8NiGkEJ8KADJ35T64eJsStWsmRf1xXkEANVjXFXnaUKbRtFwuSPCLfDdZwYNZToh4LBCd',
    },
    {
      category: 'xpubs',
      ...
      optionalParams: {
        ...
        addressLimit:
          "Forced limit on the number of addresses to search through (both 'receive' and 'change' addresses up to this number will be searched)",
      },
      testUrl:
        '/xyzpub/txids/xpub6EuV33a2DXxAhoJTRTnr8qnysu81AA4YHpLY6o8NiGkEJ8KADJ35T64eJsStWsmRf1xXkEANVjXFXnaUKbRtFwuSPCLfDdZwYNZToh4LBCd',
    },
    ...
    },
    {
      ...
      optionalParams: {
        since:
          "Use the form 'Nd' to specify the number of day to look back (e.g. 'since=7d' will analyze the last 7 days)",
        'startHeight+endHeight':
          "Use these 2 parameters to specify a custom start/end height (e.g. 'startHeight=0&endHeight=24' to analyze the first 25 blocks)",
      },
    ...
    },
    {
      ...
      optionalParams: {
        tzOffset:
          'The number of hours to offset from UTC for the caller\'s local timezone, e.g. "-5" for EST',
      },
