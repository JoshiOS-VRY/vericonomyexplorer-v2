...
export async function buildWalletBlocks(chainId: ChainId, limit: number): Promise<WalletBlock[]> {
...
export async function buildWalletChainTips(chainId: ChainId): Promise<WalletChainTip[]> {
...
export async function buildWalletPeers(chainId: ChainId, limit: number): Promise<WalletPeer[]> {
